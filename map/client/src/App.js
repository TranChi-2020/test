            ...
            <div className="map">
                ...
                </Map>
                {
                    !this.state.showMessageForm ?
                        <Button className="message-form" onClick={this.showMessageForm} color="info">Add a
                            Message</Button> :
                ...
                <Card className="footer">
                    <CardText> Made with <a href="" target="_blank" rel="noopener noreferrer">Chi Ngan</a></CardText>
                </Card>
            </div>
        );
    }
